...
class BusinessLogic(IBusinessLogic):
    ...
    def __init__(self: "BusinessLogic", game_logic: IGameLogic) -> None:
    ...
    def handle_feedback_input(self: "BusinessLogic", feedback: str) -> str:
    ...
    def get_game_state(self: "BusinessLogic"):
        return self.game_logic.get_game_state()

    def handle_computer_guess(self: "BusinessLogic") -> str:
    ...
    def handle_code_input(self: "BusinessLogic", code_input: str) -> str:
    ...
    def handle_guess_input(self: "BusinessLogic", guess_input: str) -> str:
    ...
    def handle(self: "BusinessLogic", command: str) -> str:
    ...
    def handle_server_connection(self: "BusinessLogic", ip: str, port: int) -> str:
        return self.game_logic.start_as_online_guesser(ip, port)

    def change_language(self: "BusinessLogic") -> str:
        return "choose_language"

    def end_game(self: "BusinessLogic") -> str:
        return "end_game"

    def save_game(self: "BusinessLogic") -> str:
        self.game_logic.save_game_state()
        return self.get_current_game_action()

    def load_game(self: "BusinessLogic") -> str:
        try:
    ...
    def handle_menu_action(self: "BusinessLogic", menu_choice: str) -> str:
    ...
    def get_required_action(self: "BusinessLogic", game_mode: str) -> str:
    ...
    def configure_game(self: "BusinessLogic", game_mode: str, config: dict) -> str:
    ...
    def can_start_game(self: "BusinessLogic", next_action: str) -> bool:
    ...
    def is_game_over(self: "BusinessLogic", action: str) -> bool:
        return action in ["game_won", "game_lost", "error", "cheating_detected"]

    def get_current_game_action(self: "BusinessLogic") -> str:
    ...
    def get_available_menu_actions(self: "BusinessLogic") -> list[str]:
    ...
    def confirm_save_game(self: "BusinessLogic") -> str:
        try:
            self.game_logic.save_game_state()
            return "save_game"
        except:
    ...
    def get_positions(self: "BusinessLogic") -> int:
        game_state = self.game_logic.get_game_state()
        if game_state:
            return game_state.positions
        return self.game_logic.positions

    def get_colors(self: "BusinessLogic") -> int:
        game_state = self.game_logic.get_game_state()
        if game_state:
