...
class IBusinessLogic(ABC):
    ...
    def handle_game_configuration(
        self: "IBusinessLogic", player_name: str, positions: str, colors: str, max_attempts: str
    ) -> str:
    ...
    @abstractmethod
    def process_game_action(self: "IBusinessLogic", action: str, user_input: str = None) -> str:
