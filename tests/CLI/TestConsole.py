...
class TestConsole(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=['1', '1', '12345', '887', '887', '12345', '12345'])
    def test_run(self, mock_input):
        """Test the run method to ensure it correctly processes user input."""
        self.mock_business_logic.handle.side_effect = ['choose_role', 'need_code_input', 'wait_for_computer_guess',
                                                       'need_feedback_input', 'need_feedback_input', 'need_code_input', 'need_guess_input']
